...
public class AccountTest {
    ...
    public void testAddStatementLine() {
        ...
        a1.addStatementLine(new StatementLine(new Date(2, 1, 2014), new Date(2, 1, 2014), "description", 0.0, 0, 1542, 1542, null));
    ...
    public void testTotalForMonth2() {
        a1.addStatementLine(new StatementLine(new Date(1, 12, 2013), new Date(1, 12, 2013), "description", -22.0, 0, 1542, 1542, null));
        a1.addStatementLine(new StatementLine(new Date(2, 12, 2013), new Date(2, 12, 2013), "description", -2.0, 0, 1540, 1540, null));
